...
th, td {
  ...
  $s_id=$_GET['m_id'];
  $sql ="SELECT * FROM album a,songs s,singer si,music_director m,sings s1 where s1.so_id=s.so_id and s1.s_id=si.s_id and a.a_id=s.a_id and s.m_id=m.m_id and s.m_id=$s_id";
